...
#endif
#include <stdlib.h>
void getstr_(int *nc, char *a, int *z, int cl0)
{
  int __z;
  char *_cltmp0=0;
...
void getstr2_(int *nc, char a[], int *z, int cl0)
{
  int __z;
  char *_cltmp0=0;
  /* insert Fortran-to-C conversion for a */
...
void putstr_(int *nc, const char *a, int *z, int cl0)
{
  int __z;
  char *_cltmp0=0;
  /* insert Fortran-to-C conversion for a */
...
void mstring_(void *buf, int *len, char *n1, const char *n2, int *l3, char *n_4, int *z, int cl0, int cl1, int cl2)
{
  int __z;
  char *_cltmp0=0;
  char *_cltmp1=0;
